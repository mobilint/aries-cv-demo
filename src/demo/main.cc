...
void printRuntimeHotkeys(const DemoDefinition& definition, bool debug_mode) {
    ...
    std::cout << "  d : cycle performance overlay (tile fps -> avg fps -> off)\n";
    std::cout << "  t : toggle elapsed time banner\n";
    std::cout << "  s : toggle score text on detections\n";
    std::cout << "  m : toggle fullscreen\n";
