...
cp -r assets src package/Makefile package/README.md run.sh download.sh download.bat "$PACKAGE_DIR"
find "$PACKAGE_DIR/assets" -type f \( -name '*.mxq' -o -name '*.mp4' \) -delete
